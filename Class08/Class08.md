...
The proportion of the variance that is captured by PC1 is 0.4427 which
is 44.27%.
...
original variance. Three is the first principal component that is 70% or
more.
...
original variance in the data because the seventh principal component is
the first one to have 90% or more.
...
This plot is not easy to understand. It is extremely cluttered and hard
to see anything that is going on. The thing that stands out the most to
me in this plot is the giant black circle in the middle.
...
The plots look relatively similar, however I can tell that the plots are
different by looking at the isolated points on the edges. Overall, the
plot looks like it has shifted down.
...
No, there is not any features with larger contributions than principal
component 1.
...
Using the plot, the height at which there is 4 clusters seems to be
around 16-18.

> Q12. Which method gives your favorite results for the same data.dist
> dataset? Explain your reasoning.

The table method gives more favorable results as its much clearer to
interpret and provides clear output.
...
The new model does a decent job at modeling the two separate clusters,
there is no key so differentiating between “M” and “B” is unclear.
...
The new model is more accurate than the older model because it gives us
a better output and interpretation of the results.
...
We should prioritize patient 2 as the models say the black cluster is
malignant, while the red cluster is benign.
