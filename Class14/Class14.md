...
> Q3. Finally for this section let’s reorder these results by adjusted
...
```
    ...
    Info: Working in directory /Users/masondinh/Desktop/mldinh_github_bimm143/Class14
...
> Q4. Can you do the same procedure as above to plot the pathview
...
> Q5: What pathway has the most significant “Entities p-value”? Do the
> most significant pathways listed match your previous KEGG results?
> What factors could cause differences between the two methods?

The cell cycle pathway has the smallest “Entities p-value” at 2.63E-5.
No, the most significant pathways listed do not match my KEGG results as
the numbers are different. Some factors that could cause differences
between the two methods is that Reactome and KEGG used a different list
of genes to get results. Reactome and KEGG operate two different ways as
well.
